"""
    This module contains the class to finetune the Roberta LLM on sentiment analysis and yes no question tasks.
"""
...
class RobertaFineTune:
    """
    This class contains the methods to perform Roberta finetuning.
    """
    ...
    @classmethod
    def finetune_roberta(cls, task: str):
        """
        ...
        tokenizer = RobertaTokenizer.from_pretrained(cls.base_model_name)
